                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between bg-gradient-to-r from-gray-800/50 to-gray-900/50 p-5 rounded-xl border border-white/5">
                                <div>
                                    ...
                                    <div className="text-sm text-gray-400 mt-1">Astro Framework • Premium English Support • EU Compliance</div>
                                </div>
                                <div className="text-sky-400 font-bold font-mono">€799</div>
                            </div>
